...
#     return data.get_xpos('head')

# def torso_upright(data):
#     """Returns projection from z-axes of torso to the z-axes of world."""
#     return data.xmat['torso', 'zz']
...
class HumanoidDirEnv(HumanoidEnv, Humanoid):
    ...
    def __init__(self, task={}, n_tasks=2, randomize_tasks=True):
        ...
        Humanoid.__init__(self, move_speed = _WALK_SPEED, pure_state=False)
    ...
    def step(self, action):
        ...
        # logger.log(f'Anudeep--- {dir(self.sim.data)}')
        ...
        reward = self.get_reward(self.physics)
        qpos = data.qpos
    ...
    def _get_obs(self):
        # obs_dict = self.get_observation(self.physics)
        
        #pure_state == False
        # flattened_vals = [item.flat for item in list(obs_dict.values())]
